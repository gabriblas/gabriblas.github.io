...
function getOptions() {
    return {
        ...
        qrRot: PDFLib.degrees(parseInt(document.getElementById('rotation').value || document.getElementById("rotation").placeholder)),
...
async function getPDF() {
    ...
    if (bgInput.files.length == 0) return null;
...
async function makePdf(options) {
    ...
    const alpha = options.qrRot.angle * Math.PI / 180; // deg2rad
